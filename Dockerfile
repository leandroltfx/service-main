...
# alterando o diretório de trabalho para a pasta app e gerando o .jar da aplicação com o comando maven
WORKDIR /app
...
# o container irá expor a porta 8888
EXPOSE 8888
...
# docker build -t service-main:latest .
# docker build -t service-main:latest (nome da imagem e versão) . (o ponto é para usar o Dockerfile dentro da pasta service-main)

# executando a imagem para subir um container com a aplicação na porta do container para a porta local:
# docker run -p 8888:8888 service-main:latest